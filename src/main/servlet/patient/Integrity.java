package main.servlet.patient;

import main.bean.Patient;
import main.dao.IntegrityDao;
...
public class Integrity extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<main.bean.Integrity> integrities = integrityDao.query(where, new Object[]{patient.getId()});
